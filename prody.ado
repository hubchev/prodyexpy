* prody.ado
********************************************************************************
* This program computes variations of the PRODY-Index proposed                 *
* by Hausmann et al. (2007)                                                    *
* ******************************************************************************
* please report bugs to christoph.rust@stud.uni-regensburg.de

* version  11-3-2014, balancing routine was added
* version 11-12-2014, some additional checkings
* version 12-24-2014, bug was resolved, calculating is now more efficient
*                     control flow is more intuitive
* version 01-07-2015, adding additional 'mean'-version (before vs. after)
* version 02-06-2015, bug for saving sample removed
* version 11-24-2015, lall and michaely version added
